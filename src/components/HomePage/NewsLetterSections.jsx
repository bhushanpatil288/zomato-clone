      ...
      <div className="max-w-2xl mx-auto px-4 text-center">
        ...
        <div className="flex gap-3 max-w-md mx-auto">
          <input
            ...
            className="flex-1 px-5 py-3.5 rounded-2xl border border-gray-200 dark:border-[#222222] bg-gray-50 dark:bg-[#111111] text-gray-900 dark:text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#E23744] text-sm transition-all"
          />

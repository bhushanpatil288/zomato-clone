  ...
  return (
    <div style={{ fontFamily: '\'Outfit\', sans-serif' }} className={dark ? 'dark' : ''}>
      <div className="min-h-screen flex bg-gray-50 dark:bg-[#000000]">
        ...
        {/* ── Right Form Panel ── */}
        <div className="w-full lg:w-[52%] flex flex-col items-center justify-center p-8 lg:p-16 bg-white dark:bg-[#000000] relative">
          {/* Dark toggle */}
          <button
            onClick={toggleTheme}
          ...
          <div className="w-full max-w-sm">
            ...
            <div className="flex items-center gap-2 mb-6">
              {[1, 2].map((s) => (
                <div key={s} className="flex items-center gap-2">
                  ...
                  {s === 1 && <div className={`w-8 h-0.5 ${step >= 2 ? 'bg-[#E23744]' : 'bg-gray-200 dark:bg-[#222222]'}`} />}
                </div>
              ))}
            </div>
                ...
                <>
                  ...
                  <div className='flex flex-col justify-center items-center'>
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      {/* Preview */}
                      <div className="w-24 h-24 rounded-xl overflow-hidden border border-gray-200 dark:border-[#222222] bg-gray-100 dark:bg-[#111111] flex items-center justify-center">
                        {preview ? (
                          <img
                            src={preview}
                            alt="Preview"
                  ...
                  <div>
                    ...
                    <div className="flex gap-2">
                      <div className="flex items-center gap-1 px-3 rounded-xl border border-gray-200 dark:border-[#222222] bg-gray-50 dark:bg-[#111111] text-gray-700 dark:text-gray-300 text-sm font-medium whitespace-nowrap">
                        🇮🇳 +91
                      </div>
                      <input
                        type="tel" name='phone' value={form.phone} onChange={(e) => update('phone', e.target.value)}
                        placeholder="98765 43210" required
                        className="flex-1 px-4 py-3 rounded-xl border border-gray-200 dark:border-[#222222] bg-gray-50 dark:bg-[#111111] text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-600 focus:outline-none focus:ring-2 focus:ring-[#E23744] focus:border-transparent text-sm transition-all"
                      />
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="relative">
                      <input
                        ...
                        className="w-full px-4 py-3 pr-12 rounded-xl border border-gray-200 dark:border-[#222222] bg-gray-50 dark:bg-[#111111] text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-600 focus:outline-none focus:ring-2 focus:ring-[#E23744] focus:border-transparent text-sm transition-all"
                      />
                    ...
                    {form.password && (
                      <div className="mt-2">
                        <div className="flex gap-1 mb-1">
                          {[1, 2, 3, 4].map((i) => (
                            <div key={i} className={`h-1 flex-1 rounded-full transition-all ${i <= strength ? strengthColor : 'bg-gray-200 dark:bg-[#222222]'}`} />
                          ))}
                        </div>
              ...
              <div className="flex gap-3 pt-1">
                {step === 2 && (
                  <button
                    ...
                    className="flex-1 py-3.5 border border-gray-200 dark:border-[#222222] text-gray-700 dark:text-gray-300 font-semibold rounded-xl hover:bg-gray-50 dark:hover:bg-[#111111] transition-all text-sm"
                  >
                    ← Back
                  </button>
                )}
            ...
            {step === 1 && (
              <>
                ...
                <button className="w-full flex items-center justify-center gap-3 py-3 border border-gray-200 dark:border-[#222222] rounded-xl hover:bg-gray-50 dark:hover:bg-[#111111] transition-all text-sm font-medium text-gray-700 dark:text-gray-300">
